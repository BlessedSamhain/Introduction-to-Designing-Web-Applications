...
<body class="deleteaccount_container">
    ...
    <div class="deleteaccount_footer">
        <button class=" button delete_yes"><a href="accountdeactivated">YES</a></button>
        <button class=" button delete_no_ive"><a href="settings">No, I’ve changed my mind</a></button>
    </div>
</body>